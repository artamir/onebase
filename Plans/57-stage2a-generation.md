...
### Follow-up для этапа 2b (по финальному ревью 2a)
- При **применении** diff в рабочую конфигурацию учесть зарезервированные/странные
  имена файлов на Windows (`con`, `nul`, имена с `:`): в staging они безвредны
  (temp-папка, не исполняются), но запись в реальный конфиг-каталог может упасть —
  валидировать/экранировать имя объекта на шаге apply.
